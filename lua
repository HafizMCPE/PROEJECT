...
local Window = OrionLib:MakeWindow({IntroText = "Project NooBlox Beta",Name = "Project Nooblox", HidePremium = false, SaveConfig = true, ConfigFolder = "ProjectBlox"})
...
MainTab:AddButton({
	Name = "Pendulum Hub Only Work r6 games",
	Callback = function()
...
MainTab:AddButton({
	Name = "Sushi X hub",
	Callback = function()
  		loadstring(game:HttpGet('https://pastebin.com/raw/UMJQePCH'))()
  	end    
})
...
MainTab:AddButton({
	Name = "Lunar Moon Hub",
	Callback = function()
  		loadstring(game:HttpGet('https://raw.githubusercontent.com/tyreltrijo/Lunar/main/Lunar%20Moon'))()
  	end    
})
	
MainTab:AddButton({
	Name = "Simplity v2 Hub",
	Callback = function()
...
MainTab:AddButton({
	Name = "Nullware Hub ( only work in Certain Games )",
	Callback = function()
...
MainTab:AddButton({
	Name = "Terminator Hub",
	Callback = function()
  		loadstring(game:HttpGet('https://pastebin.com/raw/VExusWZ8'))()
  	end    
})
...
GuiTab:AddButton({
	Name = "Hat Universe",
	Callback = function()
  		loadstring(game:HttpGet('https://raw.githubusercontent.com/tyreltrijo/Hat/main/HatUniverse'))()
  	end    
})
